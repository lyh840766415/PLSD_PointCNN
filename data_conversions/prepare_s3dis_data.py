...
def main():
    ...
    for area_idx in range(1, 7):
        ...
        for dataset_idx, dataset in enumerate(datasets):
            ...
            #np.savetxt('let_Me_sese.txt', xyzrgb, fmt='%.3f', delimiter=',')
            ...
            for offset_name, offset in offsets:
                ...
                print(max(point_block_indices))
                print(np.argsort(block_point_counts))
                print(block_point_counts)
                exit()
                '''
