...
def main():
    ...
    print("per_step_point",sample_num)
    print("batch_size_repeat_num",args.repeat_num)
    ...
    with tf.Session() as sess:
        ...
        for filename in filenames:
            ...
            for batch_idx in range(batch_num):
                ...
                #np.savetxt("let_me_see_0.txt",points_batch[0,...],fmt="%.3f",delimiter=",")
                ...
                print(indices_batch_shuffle.shape)
                print(indices_batch_indices.shape)
                indices_batch = np.concatenate((indices_batch_indices, indices_batch_shuffle), axis=2)
                print(indices_batch.shape)
