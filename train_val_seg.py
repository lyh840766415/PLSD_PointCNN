...
def main():
    ...
    print("what is your problem 2 ")
    if not os.path.exists(root_folder):
        os.makedirs(root_folder)
    
    print("what is your problem 3")
    '''
    if args.log != '-':
        print("what is your problem 3.1")
        print(os.path.join(root_folder, args.log))
        sys.stdout = open(os.path.join(root_folder, args.log), 'w')
    '''
    print("what is your problem 4")
    print('PID:', os.getpid())
